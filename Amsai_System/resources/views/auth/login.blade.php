                   ...
                   <a href="{{ url('/') }}"><img class="logo amsai" src="/assets/Logo.png" alt="AMSAI Logo" ></a> 
                    ...
                    <form method="POST" action="{{ route('login') }}" class="form">
                        ...
                        <span class=" invalid-feedback alert" role="alert">
                            @error('email') <strong>{{ $message }}  @enderror</strong>
                        </span>

                        <label for="email" class="label">{{ __('Email Address') }}</label>
                        <input id="email" type="email" placeholder="Enter Email Address" class="input form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">                         
                        ...
                        <input id="password" type="password" placeholder="Password" class="input form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                        
                       
                      
                            
                                    <span class="invalid-feedback alert" role="alert">
                                    @error('password')   <strong>{{ $message }}  @enderror</strong>
                                    </span>
